...
const footerLinks = {
  Topics: [
    ...
    { href: "/ai-tools", label: "AI Wellness Tools" },
  ],
  Resources: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-semibold text-[var(--foreground)]">Lumivra</span>
            </Link>
            ...
            <div className="flex gap-2 max-w-xs">
              <div className="flex items-center gap-2 flex-1 bg-[var(--card)] border border-[var(--border)] rounded-xl px-3 py-2">
              ...
              <button className="p-2.5 rounded-xl bg-[var(--accent-green)] text-white hover:opacity-90 transition-opacity shrink-0">
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border)] flex flex-col gap-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <p className="text-xs text-[var(--muted-foreground)] max-w-md sm:text-right">
